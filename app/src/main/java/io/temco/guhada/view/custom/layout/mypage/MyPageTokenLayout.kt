...
class MyPageTokenLayout constructor(
        ...
        defStyleAttr: Int = 0
) : BaseListLayout<CustomlayoutMypageTokenBinding, MyPagePointViewModel>(context, attrs, defStyleAttr), CustomCalendarFilter.CustomCalendarListener, SwipeRefreshLayout.OnRefreshListener {
