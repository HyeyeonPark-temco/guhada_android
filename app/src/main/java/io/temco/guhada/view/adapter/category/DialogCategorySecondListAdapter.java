...
public class DialogCategorySecondListAdapter extends RecyclerView.Adapter<DialogCategorySecondViewHolder> implements View.OnClickListener {
    ...
    public DialogCategorySecondListAdapter(Context context) {
        mContext = context;
