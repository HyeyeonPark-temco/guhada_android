...
import io.temco.guhada.databinding.ItemDialogCategoryFourthBinding;
import io.temco.guhada.view.holder.base.BaseCategoryViewHolder;

public class DialogCategoryFourthViewHolder extends BaseCategoryViewHolder<ItemDialogCategoryFourthBinding> {

    ////////////////////////////////////////////////
    // CONSTRUCTOR
    ////////////////////////////////////////////////

    public DialogCategoryFourthViewHolder(@NonNull View itemView) {
        super(itemView);
    }
