...
import io.temco.guhada.databinding.ActivityProductDetailTempBinding
 ...
 * @author park jungho
 * 19.07.18
 * 제품 상세 화면 임시 Activity
 */
class ProductDetailTempActivity : BindActivity<ActivityProductDetailTempBinding>(), OnProductDetailListener {
    private val dealId: Long by lazy { intent.getLongExtra("dealId", 1L) }
    ...
    override fun getLayoutId(): Int = R.layout.activity_product_detail_temp
    ...
    private fun initOptionMenu() {
        ProductDetailMenuViewModel(object : OnProductDetailMenuListener {
            ...
            override fun showMessage(message: String) {
                Toast.makeText(this@ProductDetailTempActivity, message, Toast.LENGTH_SHORT).show()
            }
       ...
       // }
        ...
        this@ProductDetailTempActivity.hideLoadingIndicator()
    }
    ...
    override fun redirectPaymentActivity(isOptionPopupSelected: Boolean) {
        ...
        if (selectedOptionCount == optionCount) {
            ...
            BaseProduct().apply {
                ...
                mViewModel.notifyPropertyChanged(BR.menuVisibility)
                Intent(this@ProductDetailTempActivity, PaymentActivity::class.java).let { intent ->
