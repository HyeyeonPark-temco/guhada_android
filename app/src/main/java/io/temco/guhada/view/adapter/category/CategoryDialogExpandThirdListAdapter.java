...
import io.temco.guhada.view.holder.category.CategoryDialogExpandThirdListViewHolder;

public class CategoryDialogExpandThirdListAdapter extends RecyclerView.Adapter<CategoryDialogExpandThirdListViewHolder> implements View.OnClickListener {
    ...
    public CategoryDialogExpandThirdListAdapter(Context context) {
        mContext = context;
    ...
    @NonNull
    @Override
    public CategoryDialogExpandThirdListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new CategoryDialogExpandThirdListViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_category_dialog_expand_third, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull CategoryDialogExpandThirdListViewHolder holder, int position) {
