...
enum class HomeType { MainEvent, SubTitleList, StoreLinear, GridList, Deal, Dummy, Keyword, BestStore, Footer, TimeDeal, EventHeader, EventList, LuckyDrawTitle , LuckyDrawTime, LuckyDrawEvent, LuckyDrawFooter}
