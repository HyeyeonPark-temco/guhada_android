...
class EventListLayout constructor(
        context: Context,
        attrs: AttributeSet? = null,
        defStyleAttr: Int = 0
) : BaseListLayout<CustomlayoutMainEventlistBinding, EventListViewModel>(context, attrs, defStyleAttr) {
    ...
    override fun getBaseTag() = EventListLayout::class.simpleName.toString()
    override fun getLayoutId() = R.layout.customlayout_main_eventlist
    override fun init() {
        mViewModel = EventListViewModel(context)
