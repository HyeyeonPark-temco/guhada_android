...
import io.temco.guhada.view.holder.category.SubCategoryAllViewHolder;
import io.temco.guhada.view.holder.category.SubCategorySecondViewHolder;

public class SubCategorySecondListAdapter extends RecyclerView.Adapter<BaseCategoryViewHolder> implements View.OnClickListener {
    ...
    public SubCategorySecondListAdapter(Context context) {
        mContext = context;
    }
    ...
    public BaseCategoryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        switch (Type.Category.getType(viewType)) {
            case ALL:
                return new SubCategoryAllViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_sub_category_all, parent, false));

            default:
                return new SubCategorySecondViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_sub_category_second, parent, false));
        }
    }
